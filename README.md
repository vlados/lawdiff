...
- [Употреба](#употреба)
- [Структура на законите](#структура-на-законите)
...
#### `GET /api/laws`
Списък на всички закони с пагинация.

**Query параметри:**
- `page` - Номер на страница (по подразбиране: 1)
- `per_page` - Записи на страница (по подразбиране: 50)

#### `GET /api/laws/{id}`
Извличане на конкретен закон със структура.
...
```json
{
  ...
  "unique_id": 11110,
  "caption": "ЗАКОН за движението по пътищата",
  "content_fetched_at": "2025-11-11T12:00:00Z",
  "processed_at": "2025-11-11T12:05:00Z",
  "nodes_count": 1592,
  "nodes": [...]
}
```
...
Извличане само на структурата на закона.

**Query параметри:**
- `node_type` - Филтриране по тип: article, paragraph, point, letter
- `level` - Филтриране по ниво на влагане
...
- `LawControllerTest` - API endpoints
